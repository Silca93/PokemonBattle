export let selectIceBeam = document.querySelector(".iceBeam");
export let selectSurf = document.querySelector(".surf")
export let selectRest = document.querySelector(".rest")
